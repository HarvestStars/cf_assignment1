...
if __name__ == "__main__":
    ...
    plt.xlabel('Trial')
    plt.ylabel('Geometric Asian Call Price')
    plt.title('Monte Carlo vs Closed-form: Geometric Asian Call (BS Model)')
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    ...
    plt.title('Distribution of MC Estimation Error')
    plt.xlabel('Error = MC Estimate - Closed-form')