...
plt.title("Temperature Series with Rolling Mean and Variance", fontsize=14)
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("figs/rolling_mean_variance.png", dpi=300, bbox_inches="tight")
plt.show()
plt.close()
...
plt.tight_layout()
plt.savefig("figs/seasonal_decomposition.png", dpi=300, bbox_inches="tight")
plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("figs/residual_distribution.png", dpi=300, bbox_inches="tight")
plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("figs/residual_qq_plot.png", dpi=300, bbox_inches="tight")
plt.show()
plt.close()
...
plt.tight_layout()
plt.savefig("figs/residual_acf_pacf.png", dpi=300, bbox_inches="tight")
plt.show()
plt.close()
